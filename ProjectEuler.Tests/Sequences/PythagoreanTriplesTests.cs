...
namespace ProjectEuler.Tests.Sequences
{
    ...
    public class PythagoreanTriplesTests
    {
        ...
        {
            var actual = new PythagoreanTriples().Take(50);
            CollectionAssert.AreEquivalent(FirstFiftyTriplets, actual);
        }


        private static readonly Triple<ulong, ulong, ulong>[] FirstFiftyTriplets = new[]
            {
